...
import { Search, Grid, List, WifiOff } from 'lucide-react';
...
export const PortfolioTemplate = () => {
    ...
    useEffect(() => {
        const fetchProjects = async () => {
            try {
                // measurePerformance is now async capable
                await measurePerformance('Projects fetch', async () => {
                ...
                setError('Unable to load projects. Please check your internet connection.');
            } finally {
                setLoading(false);
            }
        };
    ...
    return (
        <div className="min-h-screen bg-bg-dark pt-24 pb-20">
            ...
            <div className="portfolio-grid opacity-0 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 transition-opacity duration-700 delay-400">
                {error ? (
                    <div className="text-center py-24 border border-dashed border-red-500/30 rounded-lg bg-red-500/5">
                        <div className="max-w-md mx-auto">
                            <WifiOff className="w-12 h-12 text-red-500 mx-auto mb-4" />
                            <p className="text-text text-lg mb-2 font-bold">
                                Connection Issue
                            </p>
