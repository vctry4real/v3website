    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400">Track your portfolio performance and insights</p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-gray-800 rounded-lg p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-white">{totalBlogPosts}</p>
            </div>
        ...
        <div className="bg-gray-800 rounded-lg p-6">
          ...
          <div className="mt-4">
            <p className="text-sm text-gray-400">Professional entries</p>
          </div>
        </div>
        ...
        <div className="bg-gray-800 rounded-lg p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-white">{totalEducation}</p>
            </div>
            <GraduationCap className="w-8 h-8 text-yellow-400" />
          </div>
          <div className="mt-4">
            <p className="text-sm text-gray-400">Academic entries</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-gray-800 rounded-lg p-6">
          <h4 className="text-lg font-semibold text-white mb-4">Project Categories</h4>
        ...
        <div className="grid grid-cols-4 gap-4">
          {monthlyStats.map((stat) => (
            <div key={stat.month} className="text-center">
              <p className="text-sm font-medium text-gray-400">{stat.month}</p>
              <div className="mt-2 space-y-1">
                <p className="text-xs text-gray-500">Projects: {stat.projects}</p>
                <p className="text-xs text-gray-500">Posts: {stat.blogPosts}</p>
                <p className="text-xs text-gray-500">Views: {stat.views}</p>
              </div>
            </div>
          ))}
        </div>
