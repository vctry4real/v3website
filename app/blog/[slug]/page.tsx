...
import { blogService, profileImageService, type BlogData, type ProfileImageData } from '../../../components/lib/adminService';
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                const [allPosts, profileImageResult] = await Promise.all([
                    blogService.getAll(),
                ...
                setProfileImage(profileImageResult);
            } catch (error) {
    ...
    return (
        <div className="min-h-screen bg-bg-dark relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20 relative z-10">
                ...
                {/* Author Box */}
                <div className="blog-element opacity-0 bg-bg-light rounded-xl p-8 border border-border/30 shadow-lg">
